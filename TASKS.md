...
- [x] **Seed de Demonstração**: Criado o arquivo `supabase/seeds/demo_prototype_data.sql` com dados de demonstração controlados e idempotentes para popular as 11 telas principais do protótipo.
