...
export const StatusBadge: React.FC<StatusBadgeProps> = ({
  ...
  return (
    <span
      className={`text-[9px] font-bold px-2.5 py-1 rounded-full border uppercase tracking-wider inline-block text-center shadow-[0_1px_2px_rgba(0,0,0,0.01)] leading-none font-mono ${getTypeStyles()} ${className}`}
    >
      {label}
    </span>
  );
