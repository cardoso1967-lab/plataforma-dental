      ...
      <PageHero
        ...
        rightElement={
          <div className="bg-white/5 backdrop-blur-md px-5 py-3 rounded-2xl border border-white/10 text-left md:text-right shadow-inner">
            <span className="text-[11px] text-sky-300 font-extrabold block uppercase tracking-wider">Hoje é</span>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="space-y-4">
            <h3 className="text-[11px] font-extrabold text-slate-500 uppercase tracking-widest pl-1 font-mono">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
            ...
            <div className="md:col-span-1 bg-white border border-slate-200/60 p-4.5 rounded-2xl shadow-3xs flex flex-col justify-between text-left">
              <div>
                <h4 className="font-extrabold text-[11px] text-slate-450 uppercase tracking-widest font-mono">Saúde Operacional</h4>
                <div className="flex items-baseline gap-2 mt-3">
                  <span className="text-xl font-black text-slate-450 leading-none">Ainda não calculada</span>
                </div>
              ...
              <div className="flex items-center gap-2 pt-3 border-t border-slate-100/60 mt-3 text-[11px] font-extrabold text-slate-500">
            ...
            <div className="md:col-span-2 bg-white border border-slate-200/60 p-4.5 rounded-2xl shadow-3xs text-left">
              <h4 className="font-extrabold text-[11px] text-slate-455 uppercase tracking-widest font-mono">Próximas Ações Recomendadas</h4>
              
              <div className="mt-3.5 space-y-2.5 text-xs font-semibold text-slate-600">
                {metrics.noTechOS > 0 && (
                  ...
                  <table className="w-full text-left text-xs border-collapse">
                    <thead>
                      <tr className="text-slate-500 font-bold border-b border-slate-100 bg-slate-50/50 rounded-xl">
                        <th className="pb-3.5 pt-2 pl-3 font-mono text-[11px] uppercase tracking-wider">ID Pedido</th>
                        <th className="pb-3.5 pt-2 px-2 font-mono text-[11px] uppercase tracking-wider">Cliente</th>
                        <th className="pb-3.5 pt-2 text-right font-mono text-[11px] uppercase tracking-wider">Valor</th>
                        <th className="pb-3.5 pt-2 text-center pr-3 font-mono text-[11px] uppercase tracking-wider">Status</th>
                      </tr>
                    </thead>
                      ...
                      {recentSales.map((order) => (
                        <tr key={order.id} className="hover:bg-slate-50/30 transition-colors duration-150">
                          ...
                          <td className="py-4 text-center pr-3">
                            <span className={`text-[10px] font-bold px-2.5 py-0.5 rounded-full border uppercase tracking-wider shadow-3xs font-mono ${
            ...
            <div className="bg-gradient-to-b from-white to-slate-50/35 rounded-3xl border border-slate-200/80 p-6 space-y-5 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.02)]">
              <div className="flex justify-between items-center border-b border-slate-100 pb-4">
                <div className="space-y-1 text-left">
                  ...
                  <p className="text-xs text-slate-500 font-medium">Alertas de emergência e manutenções prioritárias</p>
                </div>
                <Link 
                  href="/admin/ordens-servico"
                  className="text-xs text-sky-655 font-bold hover:underline flex items-center gap-1 bg-sky-50/80 hover:bg-sky-50 px-3 py-1.5 rounded-xl border border-sky-100/40 transition-colors"
                    ...
                    >
                      <div className="space-y-1.5 text-left">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <span className={`text-[10px] font-bold px-2 py-0.5 rounded-md border uppercase tracking-wider font-mono ${
                      ...
                      <span className={`text-[10px] font-bold px-2.5 py-0.5 rounded-full border uppercase tracking-wider font-mono shadow-3xs ${
